...
This document describes the Git workflow for contributing to the governAI project.
...
- **`feat/*`**: New features
- **`experimental/*`**: Experimental features that need to be validate.

## Fork Workflow

### Step 1: Fork the Repository

1. Go to https://github.com/synobotix/governAI
...
```bash
git clone https://github.com/YOUR_USERNAME/governAI.git
cd governAI
```
...
```bash
git remote add upstream https://github.com/synobotix/governAI.git
```
...
```bash
git remote -v
origin    https://github.com/YOUR_USERNAME/governAI.git (fetch)
origin    https://github.com/YOUR_USERNAME/governAI.git (push)
upstream  https://github.com/synobotix/governAI.git (fetch)upstream  https://github.com/synobotix/governAI.git (push)
```
...
3. **Important**: Ensure the base repository is `synobotix/governAI` and the base branch is `develop`
...
3. **Set base repository to**: `synobotix/governAI`
